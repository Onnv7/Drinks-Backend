...
public class ProductService {
    ...
    public List<GetAllProductsEnabledResponse> getAllProductsEnabled(int page, int size) throws Exception {
    ...
    public List<GetAllProductsEnabledResponse> searchProductByNameOrDescription(String key, int page, int size) throws Exception {
        int skip = (page - 1) * size;
        int limit = size;
        return productRepository.searchProductByNameOrDescription(key, skip, limit);
    }

    public List<GetAllProductsEnabledResponse> getTopProductQuantityOrder(int quantity) throws Exception {
